...
	Login verification
	Inventory and sort verification
	Product details validation (title, description, price, image)
	Cart functionality (add, remove, persistence)
	Checkout information/overview validation
...
•	Summary of defects and recommendations.
________________________________________
6. Resources
